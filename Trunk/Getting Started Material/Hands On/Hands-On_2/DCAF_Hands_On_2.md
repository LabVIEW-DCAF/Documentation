...
As with any project, requirements changed and now we need to add channels for the  P,I and D values. In this section we are going to update our module channel list to match the table below:
